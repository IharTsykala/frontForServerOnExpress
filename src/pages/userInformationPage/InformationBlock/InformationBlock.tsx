...
type InformationBlockProps = {
  ...
  const InformationBlock: React.FC<InformationBlockProps> = ({
    ...
    return (        
      <section
        className={
            InformationBlockCSS.user_profile__user_information}
      >
      ...
      <ListItem button>
        <ListItemText  primary="Login:"  secondary={`${userOwnerThisPage.login}`}/>
      </ListItem>      
      <ListItem button>
        <ListItemText primary="FirstName:"  secondary={`${userOwnerThisPage.firstName}`} />
      </ListItem>
      <ListItem button>
        <ListItemText primary="LastName:"  secondary={`${userOwnerThisPage.lastName}`}/>
      </ListItem>      
      <ListItem button>
        <ListItemText primary="Email:" secondary={`${userOwnerThisPage.email}`}/>
      </ListItem>
      <ListItem button>
        <ListItemText primary="Phone:" secondary={`${userOwnerThisPage.phone}`}/>
      </ListItem>
    </List>
    <Box  className={
            ...
            component="button"
            onClick={(e: any) => handleSubmit(e)}>SOME BUTTON</Button>
            <Button  variant="outlined"
            component="button"
            onClick={(e: any) => handleSubmit(e)}>SOME BUTTON</Button>
             </Box > 
