...
import {ActionTypes , setUserOwnerThisPageActionForSagas, getFailureAction} from "./userOwnerThisPage.actions";
...
export default function* getUserOwnerThisPageForSaga() {
    yield takeEvery(ActionTypes.GET_USER_OWNER_THIS_PAGE_FOR_SAGAS, setUserOwnerThisPage);    
}