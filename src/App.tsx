      ...
      <ContextProvider>
        ...
        <main className="main">
          <Switch>
            ...
            <PrivateRoute {...defaultProtectedRouteProps} component={GetAllUsers} path="/users/all" exact />
            <PrivateRoute  {...defaultProtectedRouteProps} component={FormDataUsers} path="/user/edit" exact />
            <PrivateRoute  {...defaultProtectedRouteProps} component={GetUserByID} path="/user/:id" exact />
          </Switch>
        </main>
      </ContextProvider>
    </BrowserRouter>
